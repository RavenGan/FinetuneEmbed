...
tab_sub <- tab[tab$task %in% chosen_tasks, ]
...
# Split by model
df_lr <- df_ranked %>% filter(model == "Logistic regression")
df_rf <- df_ranked %>% filter(model == "Random forest")
...
pdf(paste0("./res/2025_0624_Plots/AUC/", fig_num, "_AUC.pdf"), width = 13, height = 6)
print(combined_plot)
dev.off()
...
pdf(paste0("./res/2025_0624_Plots/Precision/", fig_num, "_Precision.pdf"), width = 13, height = 6)
print(combined_plot)
dev.off()
...
# Combine the two plots side by side
combined_plot <- p_lr + p_rf + plot_layout(nrow = 1, guides = "collect")
pdf(paste0("./res/2025_0624_Plots/Recall/", fig_num, "_Recall.pdf"), width = 13, height = 6)
print(combined_plot)
dev.off()
...
# Combine the two plots side by side
combined_plot <- p_lr + p_rf + plot_layout(nrow = 1, guides = "collect")
pdf(paste0("./res/2025_0624_Plots/F1/", fig_num, "_F1.pdf"), width = 13, height = 6)
print(combined_plot)
dev.off()
