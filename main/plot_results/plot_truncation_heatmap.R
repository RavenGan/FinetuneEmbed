...
pdf(paste0("./res/2025_0620_Plots/AUC/Fig8_AUC_", do_CV, "_", type, ".pdf"), width = 11, height = 3)
...
pdf(paste0("./res/2025_0620_Plots/Precision/Fig8_Precision_", do_CV, "_", type, ".pdf"), width = 11, height = 3)
ggplot(df_ranked, aes(x = task, y = LLM, fill = rank)) +
  geom_tile(color = "white", width = 0.95, height = 0.95) +
  geom_text(
    aes(label = label),
...
pdf(paste0("./res/2025_0620_Plots/Recall/Fig8_Recall_", do_CV, "_", type, ".pdf"), width = 11, height = 3)
ggplot(df_ranked, aes(x = task, y = LLM, fill = rank)) +
  geom_tile(color = "white", width = 0.95, height = 0.95) +
  geom_text(
    aes(label = label),
...
pdf(paste0("./res/2025_0620_Plots/F1/Fig8_F1_", do_CV, "_", type, ".pdf"), width = 11, height = 3)
ggplot(df_ranked, aes(x = task, y = LLM, fill = rank)) +
  geom_tile(color = "white", width = 0.95, height = 0.95) +
  geom_text(
    aes(label = label),
