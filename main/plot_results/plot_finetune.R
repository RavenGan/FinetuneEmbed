...
tab <- read.csv("./res/2025_0603_All_Num_Res/finetune_Gene_Text.csv")
...
pdf(paste0("./res/2025_0605_Plots/AUC/", fig_num, "_AUC.pdf"), width = 15, height = 4)
...
pdf(paste0("./res/2025_0605_Plots/Precision/", fig_num, "_Precision.pdf"), width = 15, height = 4)
ggplot(df_ranked, aes(x = mean, y = LLM)) +
...
pdf(paste0("./res/2025_0605_Plots/Recall/", fig_num, "_Recall.pdf"), width = 15, height = 4)
ggplot(df_ranked, aes(x = mean, y = LLM)) +
...
pdf(paste0("./res/2025_0605_Plots/F1/", fig_num, "_F1.pdf"), width = 15, height = 4)
ggplot(df_ranked, aes(x = mean, y = LLM)) +
