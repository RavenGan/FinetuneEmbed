...
save_csv_dir = "./res/2024_1221/GenePT_3072_long_vs_shortTF_auc.csv"
...
save_csv_dir = "./res/2024_1221/GenePT_3072_DosageSensitivity_auc.csv"
multiple_run_TrainTest(data_dir, save_csv_dir, random_states, GPT_3_5_gene_embeddings, 
                       do_pca, do_cv)

## Bivalent vs. lys4
data_dir = "./data/MethylationState/bivalent_vs_lys4"
save_csv_dir = "./res/2024_1221/GenePT_3072_bivalent_vs_lys4_auc.csv"
multiple_run_TrainTest(data_dir, save_csv_dir, random_states, GPT_3_5_gene_embeddings, 
                       do_pca, do_cv)

## Bivalent vs. no methyl
data_dir = "./data/MethylationState/bivalent_vs_no_methyl"
save_csv_dir = "./res/2024_1221/GenePT_3072_bivalent_vs_no_methyl_auc.csv"
multiple_run_TrainTest(data_dir, save_csv_dir, random_states, GPT_3_5_gene_embeddings, 
                       do_pca, do_cv)