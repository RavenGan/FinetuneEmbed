...
# python finetuning.py \
#     --data_dir ./data/MethylationState/bivalent_vs_lys4 \
#     --csv_dir ./res/2024_1209/stella-base-en-v2/BivalentLys4/bivalent_vs_lys4_finetune_auc.csv \
#     --output_path ./res/2024_1209/stella-base-en-v2/BivalentLys4/BivalentLys4_model_ \
...
# python finetuning.py \
#     --data_dir ./data/MethylationState/bivalent_vs_lys4 \
#     --csv_dir ./res/2024_1209/e5-small/BivalentLys4/bivalent_vs_lys4_finetune_auc.csv \
#     --output_path ./res/2024_1209/e5-small/BivalentLys4/BivalentLys4_model_ \
#     --model_name intfloat/e5-small

### gte-tiny---------------------------------------------------
# python finetuning.py \
#     --data_dir ./data/MethylationState/bivalent_vs_lys4 \
#     --csv_dir ./res/2024_1209/gte-tiny/BivalentLys4/bivalent_vs_lys4_finetune_auc.csv \
#     --output_path ./res/2024_1209/gte-tiny/BivalentLys4/BivalentLys4_model_ \
