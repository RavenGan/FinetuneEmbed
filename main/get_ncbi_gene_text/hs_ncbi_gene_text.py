...
gene_df = pd.read_csv('./data_embedding/hs_unique_genes.csv')
gene_ls = [gene for gene in gene_df['hs_genes']]

gene_queries = mg.querymany(gene_ls, scopes='symbol', species='human') # extract human gene info
...
filename = './data_embedding/hs_ncbi_gene_text.json'
# Writing JSON data
