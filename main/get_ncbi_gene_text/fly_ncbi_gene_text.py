...
gene_df = pd.read_csv('./data_embedding/fly_unique_genes.csv')
gene_ls = [gene for gene in gene_df['fly_genes']]

gene_queries = mg.querymany(gene_ls, scopes='symbol', species='fruitfly') # extract fruit fly gene info
...
filename = './data_embedding/fly_ncbi_gene_text.json'
# Writing JSON data
